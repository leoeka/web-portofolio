        ...
        <section id="projects" className="px-8 py-24 bg-gray-900">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {/* Kartu Proyek 1 */}
                    <div className="bg-gray-800 rounded-2xl shadow-sm overflow-hidden hover:-translate-y-1 transition-all duration-300">
                        <img src="https://api.microlink.io/?url=https://codingcamp-7-jul-25-leoeka.vercel.app/&screenshot=true&meta=false&embed=screenshot.url" alt=" Preview Web Manajemen Tugas" className="w-full h-48 object-cover object-top" />
                        <div className="p-6">
                    ...
                    <div className="bg-gray-800 p-6 rounded-2xl shadow-sm overflow-hidden hover:-translate-y-1 transition-all duration-300">
                        <img src="https://api.microlink.io/?url=https://capstoneprojek.vercel.app/&screenshot=true&meta=false&embed=screenshot.url" alt=" Preview Website Rekomendasi Pekerjaan Berbasis AI" className="w-full h-48 object-cover object-top" />
                        <div className="p-6">
